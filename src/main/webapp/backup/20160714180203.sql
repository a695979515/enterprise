...
INSERT INTO `t_menu` VALUES (1,0,'','系统管理',20,'module','icon-cog bigger-150'),(2,1,'/manage/menu/selectList?init=y','资源管理',3,'page',NULL),(3,1,'/manage/user/selectList?init=y','网站管理员',1,'page',NULL),(6,0,'','内容管理',4,'module','icon-edit'),(7,6,'/manage/article/selectList?init=y','文章列表',2,'page',NULL),(9,6,'/manage/indexImg/selectList','门户滚动图片',6,'page',NULL),(36,1,'/manage/systemlog/selectList?init=y','日志管理',8,'page',NULL),(43,6,'/manage/articleCategory/selectList?init=y','文章分类',1,'page',NULL),(49,1,'/manage/systemSetting/toEdit?init=y','系统设置',9,'page',NULL),(52,3,'/manage/user/selectList','查询',1,'button',NULL),(55,3,'/manage/user/insert','添加',2,'button',NULL),(56,3,'/manage/user/deletes','删除',3,'button',NULL),(57,0,'/manage/user/home','首页',-100,'page','icon-desktop'),(61,2,'/manage/menu/selectList','查询',1,'button',NULL),(62,2,'/manage/menu/insert','添加',2,'button',NULL),(63,2,'/manage/menu/deletes','删除',3,'button',NULL),(107,6,'/manage/message/selectList?init=y','留言管理',5,'page',NULL),(113,6,'/manage/recruitment/selectList?init=y','招聘管理',4,'page',NULL),(114,6,'/manage/friendLinks/selectList?init=y','友情链接',3,'page',NULL),(115,1,'/manage/backups/backupsList','数据备份',5,'page',NULL),(116,6,'/manage/contact/selectList','联系我们',7,'page',NULL),(117,6,'/manage/about/selectList','关于我们',8,'page',NULL);
...
INSERT INTO `t_indeximg` VALUES (20,'装饰图1','/maven_web/attached/image/20160616/20160616095111_83.jpg',1,'#','y'),(21,'装饰图2','/maven_web/attached/image/20160616/20160616095551_748.jpg',2,'#','y'),(23,'装饰图3','/maven_web/attached/image/20160616/20160616095629_798.jpg',3,'#','y');
...
INSERT INTO `t_friendlinks` VALUES (2,'淘宝','_blank','http://www.taobao.com'),(3,'京东商城','_blank','http://www.jd.com'),(5,'阿里巴巴','_blank','http://www.alibaba.com'),(6,'阿里巴中国站','_blank','http://www.1688.com'),(7,'支付宝','_blank','http://www.alipay.com'),(8,'阿里云计算','_self','http://www.aliyun.com'),(11,'万网','_blank','http://www.net.cn'),(13,'天猫商城','_blank','http://www.tmall.com'),(14,'当当网','_self','http://www.dangdang.com'),(15,'苏宁','_blank','http://www.suning.com'),(16,'百度','_blank','http://www.baidu.com');
...
LOCK TABLES `t_articlecategory` WRITE;
/*!40000 ALTER TABLE `t_articlecategory` DISABLE KEYS */;
INSERT INTO `t_articlecategory` VALUES (1,'公司动态','公司的最新新闻在此发布','GongSiDongTai',1),(2,'行业新闻','最新行业资讯','XingYeXinWen',2);
...
INSERT INTO `t_about` VALUES (6,'关于我们');
